                  ...
                  children: [
                    ...
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.palette, color: Color(0xFF0058A3), size: 20),
                            const SizedBox(width: 8),
                            Text(
                              'Tema',
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              obscureText: obscureText && !isEditing ? true : (obscureText && isEditing ? false : false),
              maxLength: maxLength,
              decoration: InputDecoration(
                hintText: label == 'Şifre' ? 'Yeni şifrenizi girin' : '$label girin',
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                ),
