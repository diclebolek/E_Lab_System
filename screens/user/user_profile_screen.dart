...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  Future<void> _updatePassword() async {
    if (_passwordController.text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Yeni şifrenizi girin')),
      );
      return;
    }
    ...
    final success = await FirebaseService.updatePassword(_passwordController.text);
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton(
                          onPressed: () {
                            ...
                            _loadUserData(); // Orijinal değerlere geri dön
                          },
                    ...
                    if (!_isEditing && (_createdAt.isNotEmpty || _updatedAt.isNotEmpty)) ...[
                      const SizedBox(height: 40),
                      const Divider(),
                      const SizedBox(height: 20),
